                                ...
                                <table id="example" class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <div class="btn-group">
                                               <button onclick='edit_progress(<?php echo $p->id_progress ?>)' id="btn-edit" class="btn btn-primary btn-md" data-toggle="modal" data-target="#ModalEdit"><i class="far fa-edit"></i></button>
